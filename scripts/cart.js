document.addEventListener('DOMContentLoaded', function() {
    ...
    var formsDelivery = document.querySelectorAll('.shoppingCartDeliveryForm'); // Get all forms with id "shoppingCartForm"

    formsDelivery.forEach(function(form) {
        form.addEventListener('submit', function(event) {
            event.preventDefault(); // Prevent the default form submission
            ...
            .then(data => {
                console.log('Success:', data);
                // Reload the page containing the form
                window.location.href = "http://gourmethaven.byethost4.com/delivery.php#";
            })
            .catch((error) => {
                console.error('Error:', error);
            });
